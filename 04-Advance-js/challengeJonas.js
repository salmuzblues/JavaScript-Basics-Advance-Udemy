...
/* (function(){
    ...
    Question.prototype.displayQuestion = function(){
        console.log(this.question);  // this is for showing question 
        // this is for showing the answers
        for(var i = 0; i < this.answers.length; i++){
            console.log( i + ': '+ this.answers[i])
        }
    }

    Question.prototype.checkAnswer = function(result){
        if (this.correct === result){
    ...
    var q2 = new Question('What is the name of this course\'s teacher?', ['Jhon', 'Michael', 'Jonas'], 2);
    var q3 = new Question('What does the best describe coding?', ['Boring', 'Hard', 'Fun', 'Tediuos'], 2); 
...
Question.prototype.checkAnswer = function(result, callBack){
   var sc; 
    if (this.correct === result){
        console.log('Correct Answer!'); 
        sc = callBack(true); 
